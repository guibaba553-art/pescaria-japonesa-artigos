...
CREATE INDEX IF NOT EXISTS idx_products_search_trgm ON public.products
USING gin (
  name gin_trgm_ops,
...
CREATE INDEX IF NOT EXISTS idx_variations_search_trgm ON public.product_variations
USING gin (
  name gin_trgm_ops,
  sku gin_trgm_ops
);
